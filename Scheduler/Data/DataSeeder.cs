...
namespace Scheduler.Data
{
    public class DataSeeder
    {
        ...
        private void SeedUsers()
        {
            ...
            _dbContext.Users.AddRange(userFaker.Generate(10)); // Reduce to 10 additional users
        ...
        private void SeedCustomers()
        {
            ...
            var addressFaker = new Faker<Models.AddressModel>()
                ...
                .RuleFor(a => a.Phone, f => f.Phone.PhoneNumber().PadRight(15).Substring(0, 15))
            ...
            _dbContext.Customers.AddRange(customerFaker.Generate(20)); // Reduce to 20 customers
        ...
        private void SeedAppointments()
        {
            ...
            foreach (var user in users)
            {
                ...
                {
                    // Generate appointments for last month, this month, and next month
                    for (int monthOffset = -1; monthOffset <= 1; monthOffset++)
                    {
                        GenerateAppointmentsForUserAndCustomer(user, customer, monthOffset);
                    }
                }
            }
        ...
        private void GenerateAppointmentsForUserAndCustomer(Models.UserModel user, Models.CustomerModel customer,
            int monthOffset)
        {
            var faker = new Faker();
            ...
            for (var date = startDate; date < endDate; date = date.AddDays(1))
            {
                ...
                var appointmentCount = faker.Random.Int(1, 3); // Generate 1 to 3 appointments per day
